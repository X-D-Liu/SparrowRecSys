...
training_samples_file_path = tf.keras.utils.get_file("trainingSamples.csv","../../../../../../src/main/resources/webroot/sampledata/trainingSamples.csv")
# Test samples path, change to your local path
test_samples_file_path = tf.keras.utils.get_file("testSamples.csv","../../../../../../src/main/resources/webroot/sampledata/trainingSamples.csv")
